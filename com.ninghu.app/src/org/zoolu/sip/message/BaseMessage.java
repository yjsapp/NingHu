...
public abstract class BaseMessage
{
   ...
   private String message;
   	//public static String message;//修改
   ...
   {  removeBody();
      ...
      {  setContentTypeHeader(new ContentTypeHeader(content_type));
         setContentLengthHeader(new ContentLengthHeader(body.length()));  //消息体长度
         message=message+"\r\n"+body;
         //+"\r\n"
      }
      else
   ...
   {  setBody("application/xml",body);//修改
   }   
   //修改
   public void setRespBody(){
	   setContentLengthHeader(new ContentLengthHeader(0));
       message=message+"\r\n";
   }
   ...
   {  //if (!hasBody()) return "";
     ...
     // if (this.hasContentLengthHeader()) len=getContentLengthHeader().getContentLength();//修改
     // else
