...
import com.superapp.main.Photos;
...
public class CropImage {
	...
	public CropImage(Context context, PhotoImageView imageView,Handler handler)
	{
		mContext = context;
...
//    		mProgress.show();
    	...
    	public void run()
    	{
    		...
    		mHandler.post(new Runnable() {
                public void run() {
                    try{
                    	mHandler.sendMessage(mHandler.obtainMessage(Photos.SHOW_PROGRESS));
...
//    					}
    		...
    		{
    			mHandler.sendMessage(mHandler.obtainMessage(Photos.REMOVE_PROGRESS));
//    			mHandler.post(new Runnable()
//    			{
//    				public void run()
//    				{
