...
public class VideosViewAdapter extends BaseAdapter
{
	  private static final String TAG = "VideosViewAdapter";
	  ...
	  public VideosViewAdapter(Context context, int f, String name, String[] rows)
	  {
