...
import com.superapp.view.GridViewAdapter;
       ...
       gView.setAdapter(new GridViewAdapter(this,flag, name, getNames(flag, albums)));
	    ...
	    gView.setOnItemClickListener(new OnItemClickListener(){  
	           ...
	           {  
	        		 ...
	        		 intent.setClass(ImageGridView.this, ImageGalleryPlay.class);  
	        		 intent.putExtra("path", path);
	        		 intent.putExtra("id", position);
	        		 intent.putExtra("data", (String[])pathArray.toArray(new String[pathArray.size()]));
	        		 Log.i("ImageGridView_setOnItemClickListener", "position1111122222="+position+"; path="+path);
