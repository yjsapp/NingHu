 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_org_opencore_avch264_NativeH264Decoder_InitDecoder
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_org_opencore_avch264_NativeH264Decoder_DeinitDecoder
 ...
 * Signature: ([B[IJ)[I
 */
JNIEXPORT jint JNICALL Java_org_opencore_avch264_NativeH264Decoder_DecodeAndConvert
 ...
 */
JNIEXPORT jint JNICALL Java_org_opencore_avch264_NativeH264Decoder_InitParser
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_org_opencore_avch264_NativeH264Decoder_DeinitParser
  (JNIEnv *env, jclass clazz){
	parserInitialized = 0;
	return release();
}
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_org_opencore_avch264_NativeH264Decoder_getVideoLength
  (JNIEnv *env, jclass clazz)
{
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_org_opencore_avch264_NativeH264Decoder_getVideoWidth
  (JNIEnv *env, jclass clazz)
{
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_org_opencore_avch264_NativeH264Decoder_getVideoHeight
  (JNIEnv *env, jclass clazz)
{
 ...
 */
JNIEXPORT jstring JNICALL Java_org_opencore_avch264_NativeH264Decoder_getVideoCoding
  (JNIEnv *env, jclass clazz)
{
 ...
 */
JNIEXPORT jobject JNICALL Java_org_opencore_avch264_NativeH264Decoder_getVideoSample
