 ...
 * Signature: (IIF)I
 */
JNIEXPORT jint JNICALL Java_org_opencore_avch264_NativeH264Encoder_InitEncoder
 ...
 * Signature: ([BJ)[B
 */
JNIEXPORT jbyteArray JNICALL Java_org_opencore_avch264_NativeH264Encoder_EncodeFrame
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_org_opencore_avch264_NativeH264Encoder_getLastEncodeStatus
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_org_opencore_avch264_NativeH264Encoder_DeinitEncoder
  (JNIEnv *env, jclass clazz){
    delete(encoder);
    free(iInputFormat);
    free(iEncodeParam);
...
JNIEXPORT jint JNICALL Java_org_opencore_avch264_NativeH264Encoder_getKeyFrame
(JNIEnv *, jclass){
	if(iOutData)
	{
		if(iOutData->iKeyFrame) 
		{
			return 0x64;	
		}
		else 
